...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.ApplicationLayer":           schema_libcalico_go_lib_apis_internalapi_ApplicationLayer(ref),
		"github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.AuthorizedResourceGroup":    schema_libcalico_go_lib_apis_internalapi_AuthorizedResourceGroup(ref),
		...
		"github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.EgressGatewayStatus":        schema_libcalico_go_lib_apis_internalapi_EgressGatewayStatus(ref),
		...
		"github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.WorkloadEndpointStatus":     schema_libcalico_go_lib_apis_internalapi_WorkloadEndpointStatus(ref),
...
func schema_libcalico_go_lib_apis_internalapi_ApplicationLayer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_libcalico_go_lib_apis_internalapi_AuthorizedResourceGroup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_libcalico_go_lib_apis_internalapi_EgressGatewayStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_libcalico_go_lib_apis_internalapi_WorkloadEndpoint(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.WorkloadEndpointStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.WorkloadEndpointSpec", "github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.WorkloadEndpointStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_libcalico_go_lib_apis_internalapi_WorkloadEndpointPort(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/tigera/api/pkg/lib/numorstring.Protocol"},
	}
}
...
func schema_libcalico_go_lib_apis_internalapi_WorkloadEndpointSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"applicationLayer": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.ApplicationLayer"),
						},
					},
					"qosControls": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.ApplicationLayer", "github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.IPNAT", "github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.QoSControls", "github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.WorkloadEndpointPort", "github.com/tigera/api/pkg/apis/projectcalico/v3.EgressGatewaySpec"},
	}
}

func schema_libcalico_go_lib_apis_internalapi_WorkloadEndpointStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"egressGateway": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.EgressGatewayStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/projectcalico/calico/libcalico-go/lib/apis/internalapi.EgressGatewayStatus"},
	}
}
