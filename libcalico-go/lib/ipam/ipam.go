...
func (c ipamClient) AutoAssign(ctx context.Context, args AutoAssignArgs) (*IPAMAssignments, *IPAMAssignments, error) {
	...
	if args.Num4 != 0 {
		...
		v4ia, err = c.autoAssign(ctx, args.Num4, args.HandleID, args.Attrs, args.IPv4Pools, 4, hostname, args.MaxBlocksPerHost, args.HostReservedAttrIPv4s, args.IntendedUse, args.AWSSubnetIDs, args.Namespace, args.MaxAllocToHandlePerIPVersion)
		if err != nil {
	...
	if args.Num6 != 0 {
		...
		v6ia, err = c.autoAssign(ctx, args.Num6, args.HandleID, args.Attrs, args.IPv6Pools, 6, hostname, args.MaxBlocksPerHost, args.HostReservedAttrIPv6s, args.IntendedUse, args.AWSSubnetIDs, args.Namespace, args.MaxAllocToHandlePerIPVersion)
		if err != nil {
...
func (c ipamClient) prepareAffinityBlocksForHost(ctx context.Context, requestedPools []net.IPNet, version int, host string, rsvdAttr *HostReservedAttr, use v3.IPPoolAllowedUse, awsSubnetIDs []string, namespace *corev1.Namespace) ([]v3.IPPool, []net.IPNet, error) {
...
func filterPoolsByAWSSubnetID(pools []v3.IPPool, awsSubnetIDs []string) []v3.IPPool {
	...
	if len(awsSubnetIDs) == 0 {
		...
		for _, p := range pools {
			...
			if slices.Contains(awsSubnetIDs, p.Spec.AWSSubnetID) {
				filteredPools = append(filteredPools, p)
			}
		}
	}
...
func (c ipamClient) autoAssign(ctx context.Context, num int, handleID *string, attrs map[string]string, requestedPools []net.IPNet, version int, host string, maxNumBlocks int, rsvdAttr *HostReservedAttr, use v3.IPPoolAllowedUse, awsSubnetIDs []string, namespace *corev1.Namespace, maxAlloc int) (*IPAMAssignments, error) {
	// Default parameters.
	if use == "" {
	...
	logCtx.Info("Looking up existing affinities for host")
	pools, affBlocks, err := c.prepareAffinityBlocksForHost(ctx, requestedPools, version, host, rsvdAttr, use, awsSubnetIDs, namespace)
	if err != nil {
		return nil, err
	}
...
func (c ipamClient) EnsureBlock(ctx context.Context, args BlockArgs) (*net.IPNet, *net.IPNet, error) {
	...
	if args.HostReservedAttrIPv4s != nil {
		...
		v4Net, err = c.ensureBlock(ctx, args.HostReservedAttrIPv4s, args.IPv4Pools, 4, args.AWSSubnetIDs, affinityCfg)
		if err != nil {
	...
	if args.HostReservedAttrIPv6s != nil {
		...
		v6Net, err = c.ensureBlock(ctx, args.HostReservedAttrIPv6s, args.IPv4Pools, 6, args.AWSSubnetIDs, affinityCfg)
		if err != nil {
...
func (c ipamClient) ensureBlock(ctx context.Context, rsvdAttr *HostReservedAttr, requestedPools []net.IPNet, version int, awsSubnetIDs []string, affinityCfg AffinityConfig) (*net.IPNet, error) {
	...
	pools, affBlocks, err := c.prepareAffinityBlocksForHost(ctx, requestedPools, version, affinityCfg.Host, rsvdAttr, v3.IPPoolAllowedUseWorkload, awsSubnetIDs, nil)
	if err != nil {
		return nil, err
	}
