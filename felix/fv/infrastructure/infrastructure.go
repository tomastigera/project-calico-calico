...
type DatastoreInfra interface {
	...
	// GetRemoteClusterConfig constructs the RemoteClusterConfiguration that can be used
	// to connect to this datastore remotely.
	GetRemoteClusterConfig() *api.RemoteClusterConfiguration
