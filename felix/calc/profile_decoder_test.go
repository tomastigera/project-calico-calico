...
func (p *passthruCallbackRecorder) OnHostMetadataUpdate(hostname string, ip4 *net.IPNet, ip6 *net.IPNet, asnumber string, lbMaintenance proto.LoadbalancerMaintenance, labels map[string]string) {
