...
var fooPolicyID = types.PolicyID{Name: "default.foo", Kind: v3.KindGlobalNetworkPolicy}
...
var _ = Describe("Protobuf rule to iptables rule conversion", func() {
	...
	DescribeTable(
		...
		func(ipVer int, in *proto.Rule, expMatch string) {
			...
			rules := renderer.ProtoRuleToIptablesRules(in, uint8(ipVer),
				RuleOwnerTypePolicy, RuleDirIngress, 0, fooPolicyID, false)
	...
	DescribeTable(
		...
		func(ipVer int, in *proto.Rule, expMatch string) {
			...
			rules := renderer.ProtoRuleToIptablesRules(logRule, uint8(ipVer),
				RuleOwnerTypePolicy, RuleDirIngress, 0, types.PolicyID{Name: "default.foo", Kind: v3.KindGlobalNetworkPolicy}, false)
	...
	DescribeTable(
		...
		func(ipVer int, in *proto.Rule, expMatch string) {
			...
			Expect(inbound[1]).To(Equal(generictables.Rule{
				Match: iptables.Match().
					MarkSingleBitSet(0x00001).
					NotMarkMatchesWithMask(0x400000, 0x400000).
					MarkSingleBitSet(0x800),
				Action: iptables.NfqueueAction{QueueNum: 100},
			}))
	...
	DescribeTable(
		"Deny rules should be correctly rendered in LOGandDROP mode with flowlogs enabled",
		func(ipVer int, in *proto.Rule, expMatch string) {
			rrConfigNormal.FlowLogsEnabled = true
			rrConfigLogAndDrop := rrConfigNormal
			rrConfigLogAndDrop.ActionOnDrop = "LOGandDROP"
	...
	DescribeTable(
		"Deny rules should be correctly rendered in ACCEPT mode with flowlogs enabled",
		func(ipVer int, in *proto.Rule, expMatch string) {
			rrConfigNormal.FlowLogsEnabled = true
			rrConfigLogAndAccept := rrConfigNormal
			rrConfigLogAndAccept.ActionOnDrop = "ACCEPT"
	...
	Context("with default renderer", func() {
		...
		It("should skip rules of incorrect IP version", func() {
			rules := renderer.ProtoRulesToIptablesRules([]*proto.Rule{{IpVersion: 4}}, 6,
				RuleOwnerTypePolicy, RuleDirIngress, fooPolicyID, false)
...
var _ = Describe("DNS policy rules", func() {
	...
	DescribeTable("with DNSPolicyModes",
		func(mode v3.DNSPolicyMode, expectDNSMark bool) {
			pRule := proto.Rule{
