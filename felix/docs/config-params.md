...
### `WindowsDNSCacheFile` (config file) / `windowsDnsCacheFile` (YAML)

The name of the file that Felix uses to preserve learnt DNS information when restarting. .

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_WindowsDNSCacheFile` |
| Encoding (env var/config file) | Path to file |
| Default value (above encoding) | `c:\TigeraCalico\felix-dns-cache.txt` |
| `FelixConfiguration` field | `windowsDnsCacheFile` (YAML) `WindowsDNSCacheFile` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `c:\TigeraCalico\felix-dns-cache.txt` |

### `WindowsDNSExtraTTL` (config file) / `windowsDnsExtraTTL` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_WindowsDNSExtraTTL` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `120` (2m0s) |
| `FelixConfiguration` field | `windowsDnsExtraTTL` (YAML) `WindowsDNSExtraTTL` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `2m0s` |

### `WindowsFlowLogsFileDirectory` (config file) / `windowsFlowLogsFileDirectory` (YAML)

Sets the directory where flow logs files are stored on Windows nodes. .

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_WindowsFlowLogsFileDirectory` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `c:\TigeraCalico\flowlogs` |
| `FelixConfiguration` field | `windowsFlowLogsFileDirectory` (YAML) `WindowsFlowLogsFileDirectory` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `c:\TigeraCalico\flowlogs` |

### `WindowsFlowLogsPositionFilePath` (config file) / `windowsFlowLogsPositionFilePath` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_WindowsFlowLogsPositionFilePath` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `c:\TigeraCalico\flowlogs\flows.log.pos` |
| `FelixConfiguration` field | `windowsFlowLogsPositionFilePath` (YAML) `WindowsFlowLogsPositionFilePath` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `c:\TigeraCalico\flowlogs\flows.log.pos` |
...
### `WindowsNetworkName` (config file) / `windowsNetworkName` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_WindowsNetworkName` |
| Encoding (env var/config file) | Regular expression |
| Default value (above encoding) | `(?i)calico.*` |
| `FelixConfiguration` field | `windowsNetworkName` (YAML) `WindowsNetworkName` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `(?i)calico.*` |

### `WindowsStatsDumpFilePath` (config file) / `windowsStatsDumpFilePath` (YAML)

Used to specify the path of the stats dump file on Windows nodes.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_WindowsStatsDumpFilePath` |
| Encoding (env var/config file) | Path to file |
| Default value (above encoding) | `c:\TigeraCalico\stats\dump` |
| `FelixConfiguration` field | `windowsStatsDumpFilePath` (YAML) `WindowsStatsDumpFilePath` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `c:\TigeraCalico\stats\dump` |
| Notes | Felix will exit if the value is invalid. | 
...
## <a id="overlay-ipsec">Overlay: IPSec

### `IPSecAllowUnsecuredTraffic` (config file) / `ipsecAllowUnsecuredTraffic` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_IPSecAllowUnsecuredTraffic` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `ipsecAllowUnsecuredTraffic` (YAML) `IPSecAllowUnsecuredTraffic` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `IPSecESPAlgorithm` (config file) / `ipsecESPAlgorithm` (YAML)

IPSecESAlgorithm sets IPSec ESP algorithm. Default is NIST suite B recommendation.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_IPSecESPAlgorithm` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `aes128gcm16-ecp256` |
| `FelixConfiguration` field | `ipsecESPAlgorithm` (YAML) `IPSecESPAlgorithm` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `aes128gcm16-ecp256` |

### `IPSecIKEAlgorithm` (config file) / `ipsecIKEAlgorithm` (YAML)

Sets IPSec IKE algorithm. Default is NIST suite B recommendation.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_IPSecIKEAlgorithm` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `aes128gcm16-prfsha256-ecp256` |
| `FelixConfiguration` field | `ipsecIKEAlgorithm` (YAML) `IPSecIKEAlgorithm` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `aes128gcm16-prfsha256-ecp256` |

### `IPSecLogLevel` (config file) / `ipsecLogLevel` (YAML)

Controls log level for IPSec components. Set to None for no logging.
A generic log level terminology is used [None, Notice, Info, Debug, Verbose].

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_IPSecLogLevel` |
| Encoding (env var/config file) | One of: <code>DEBUG</code>, <code>INFO</code>, <code>NOTICE</code>, <code>VERBOSE</code> (case insensitive) |
| Default value (above encoding) | `INFO` |
| `FelixConfiguration` field | `ipsecLogLevel` (YAML) `IPSecLogLevel` (Go API) |
| `FelixConfiguration` schema | One of: <code>Debug</code>, <code>Info</code>, <code>None</code>, <code>Notice</code>, <code>Verbose</code>. |
| Default value (YAML) | `Info` |

### `IPSecMode` (config file) / `ipsecMode` (YAML)

Controls which mode IPSec is operating on.
Default value means IPSec is not enabled.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_IPSecMode` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | none |
| `FelixConfiguration` field | `ipsecMode` (YAML) `IPSecMode` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | none |

### `IPSecPSKFile` (config file / env var only)

File contains PSK.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_IPSecPSKFile` |
| Encoding (env var/config file) | Path to file, which must exist |
| Default value (above encoding) | none |
| Notes | Config file / env var only. | 

### `IPSecPolicyRefreshInterval` (config file) / `ipsecPolicyRefreshInterval` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_IPSecPolicyRefreshInterval` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `600` (10m0s) |
| `FelixConfiguration` field | `ipsecPolicyRefreshInterval` (YAML) `IPSecPolicyRefreshInterval` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `10m0s` |

## <a id="flow-logs-prometheus-reports">Flow logs: Prometheus reports

### `DeletedMetricsRetentionSecs` (config file) / `deletedMetricsRetentionSecs` (YAML)

Controls how long metrics are retianed after the flow is gone.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DeletedMetricsRetentionSecs` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `30` (30s) |
| `FelixConfiguration` field | `deletedMetricsRetentionSecs` (YAML) `DeletedMetricsRetentionSecs` (Go API) |
| `FelixConfiguration` schema | Integer. |
| Default value (YAML) | `30s` |

### `PrometheusReporterCAFile` (config file) / `prometheusReporterCAFile` (YAML)

The path to the TLS CA file for the Prometheus per-flow metrics reporter.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_PrometheusReporterCAFile` |
| Encoding (env var/config file) | Path to file, which must exist |
| Default value (above encoding) | none |
| `FelixConfiguration` field | `prometheusReporterCAFile` (YAML) `PrometheusReporterCAFile` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | none |

### `PrometheusReporterCertFile` (config file) / `prometheusReporterCertFile` (YAML)

The path to the TLS certificate file for the Prometheus per-flow metrics reporter.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_PrometheusReporterCertFile` |
| Encoding (env var/config file) | Path to file, which must exist |
| Default value (above encoding) | none |
| `FelixConfiguration` field | `prometheusReporterCertFile` (YAML) `PrometheusReporterCertFile` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | none |

### `PrometheusReporterEnabled` (config file) / `prometheusReporterEnabled` (YAML)

Controls whether the Prometheus per-flow metrics reporter is enabled. This is
used to show real-time flow metrics in the UI.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_PrometheusReporterEnabled` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `prometheusReporterEnabled` (YAML) `PrometheusReporterEnabled` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `PrometheusReporterKeyFile` (config file) / `prometheusReporterKeyFile` (YAML)

The path to the TLS private key file for the Prometheus per-flow metrics reporter.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_PrometheusReporterKeyFile` |
| Encoding (env var/config file) | Path to file, which must exist |
| Default value (above encoding) | none |
| `FelixConfiguration` field | `prometheusReporterKeyFile` (YAML) `PrometheusReporterKeyFile` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | none |

### `PrometheusReporterPort` (config file) / `prometheusReporterPort` (YAML)

The port that the Prometheus per-flow metrics reporter should bind to.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_PrometheusReporterPort` |
| Encoding (env var/config file) | Integer: [0,65535] |
| Default value (above encoding) | `9092` |
| `FelixConfiguration` field | `prometheusReporterPort` (YAML) `PrometheusReporterPort` (Go API) |
| `FelixConfiguration` schema | Integer: [0,65535] |
| Default value (YAML) | `9092` |

## <a id="flow-logs-syslog-reports">Flow logs: Syslog reports

### `SyslogReporterAddress` (config file) / `syslogReporterAddress` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_SyslogReporterAddress` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | none |
| `FelixConfiguration` field | `syslogReporterAddress` (YAML) `SyslogReporterAddress` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | none |

### `SyslogReporterEnabled` (config file) / `syslogReporterEnabled` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_SyslogReporterEnabled` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `syslogReporterEnabled` (YAML) `SyslogReporterEnabled` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `SyslogReporterNetwork` (config file) / `syslogReporterNetwork` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_SyslogReporterNetwork` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | none |
| `FelixConfiguration` field | `syslogReporterNetwork` (YAML) `SyslogReporterNetwork` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | none |

## <a id="flow-logs-file-reports">Flow logs: file reports

### `FlowLogsAggregationThresholdBytes` (config file) / `flowLogsAggregationThresholdBytes` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsAggregationThresholdBytes` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `8192` |
| `FelixConfiguration` field | `flowLogsAggregationThresholdBytes` (YAML) `FlowLogsAggregationThresholdBytes` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `8192` |

### `FlowLogsCollectProcessInfo` (config file) / `flowLogsCollectProcessInfo` (YAML)

If enabled Felix will load the kprobe BPF programs to collect process info.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsCollectProcessInfo` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsCollectProcessInfo` (YAML) `FlowLogsCollectProcessInfo` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `FlowLogsCollectProcessPath` (config file) / `flowLogsCollectProcessPath` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsCollectProcessPath` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsCollectProcessPath` (YAML) `FlowLogsCollectProcessPath` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `FlowLogsCollectTcpStats` (config file) / `flowLogsCollectTcpStats` (YAML)

Enables flow logs reporting TCP socket stats.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsCollectTcpStats` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsCollectTcpStats` (YAML) `FlowLogsCollectTcpStats` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |
...
### `FlowLogsDestDomainsByClient` (config file) / `flowLogsDestDomainsByClient` (YAML)

Used to configure if the source IP is used in the mapping of top
level destination domains.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsDestDomainsByClient` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `true` |
| `FelixConfiguration` field | `flowLogsDestDomainsByClient` (YAML) `FlowLogsDestDomainsByClient` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `true` |

### `FlowLogsDynamicAggregationEnabled` (config file) / `flowLogsDynamicAggregationEnabled` (YAML)

Used to enable/disable dynamically changing aggregation levels. Default is true.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsDynamicAggregationEnabled` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsDynamicAggregationEnabled` (YAML) `FlowLogsDynamicAggregationEnabled` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `FlowLogsEnableHostEndpoint` (config file) / `flowLogsEnableHostEndpoint` (YAML)

Enables Flow logs reporting for HostEndpoints.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsEnableHostEndpoint` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsEnableHostEndpoint` (YAML) `FlowLogsEnableHostEndpoint` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |
...
### `FlowLogsFileAggregationKindForAllowed` (config file) / `flowLogsFileAggregationKindForAllowed` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileAggregationKindForAllowed` |
| Encoding (env var/config file) | Integer: [0,3] |
| Default value (above encoding) | `2` |
| `FelixConfiguration` field | `flowLogsFileAggregationKindForAllowed` (YAML) `FlowLogsFileAggregationKindForAllowed` (Go API) |
| `FelixConfiguration` schema | One of: <code>0</code>, <code>1</code>, <code>2</code>. |
| Default value (YAML) | `2` |

### `FlowLogsFileAggregationKindForDenied` (config file) / `flowLogsFileAggregationKindForDenied` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileAggregationKindForDenied` |
| Encoding (env var/config file) | Integer: [0,3] |
| Default value (above encoding) | `1` |
| `FelixConfiguration` field | `flowLogsFileAggregationKindForDenied` (YAML) `FlowLogsFileAggregationKindForDenied` (Go API) |
| `FelixConfiguration` schema | One of: <code>0</code>, <code>1</code>, <code>2</code>, <code>3</code>. |
| Default value (YAML) | `1` |

### `FlowLogsFileDirectory` (config file) / `flowLogsFileDirectory` (YAML)

Sets the directory where flow logs files are stored.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileDirectory` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `/var/log/calico/flowlogs` |
| `FelixConfiguration` field | `flowLogsFileDirectory` (YAML) `FlowLogsFileDirectory` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `/var/log/calico/flowlogs` |

### `FlowLogsFileDomainsLimit` (config file) / `flowLogsFileDomainsLimit` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileDomainsLimit` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `5` |
| `FelixConfiguration` field | `flowLogsFileDomainsLimit` (YAML) `FlowLogsFileDomainsLimit` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `5` |

### `FlowLogsFileEnabled` (config file) / `flowLogsFileEnabled` (YAML)

When set to true, enables logging flow logs to a file. If false no flow logging to file will occur.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileEnabled` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsFileEnabled` (YAML) `FlowLogsFileEnabled` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `FlowLogsFileEnabledForAllowed` (config file) / `flowLogsFileEnabledForAllowed` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileEnabledForAllowed` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `true` |
| `FelixConfiguration` field | `flowLogsFileEnabledForAllowed` (YAML) `FlowLogsFileEnabledForAllowed` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `true` |

### `FlowLogsFileEnabledForDenied` (config file) / `flowLogsFileEnabledForDenied` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileEnabledForDenied` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `true` |
| `FelixConfiguration` field | `flowLogsFileEnabledForDenied` (YAML) `FlowLogsFileEnabledForDenied` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `true` |

### `FlowLogsFileIncludeLabels` (config file) / `flowLogsFileIncludeLabels` (YAML)

Used to configure if endpoint labels are included in a Flow log entry written to file.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileIncludeLabels` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsFileIncludeLabels` (YAML) `FlowLogsFileIncludeLabels` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `FlowLogsFileIncludePolicies` (config file) / `flowLogsFileIncludePolicies` (YAML)

Used to configure if policy information are included in a Flow log entry written to file.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileIncludePolicies` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsFileIncludePolicies` (YAML) `FlowLogsFileIncludePolicies` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `FlowLogsFileIncludeService` (config file) / `flowLogsFileIncludeService` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileIncludeService` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `flowLogsFileIncludeService` (YAML) `FlowLogsFileIncludeService` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `FlowLogsFileMaxFileSizeMB` (config file) / `flowLogsFileMaxFileSizeMB` (YAML)

Sets the max size in MB of flow logs files before rotation.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileMaxFileSizeMB` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `100` |
| `FelixConfiguration` field | `flowLogsFileMaxFileSizeMB` (YAML) `FlowLogsFileMaxFileSizeMB` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `100` |

### `FlowLogsFileMaxFiles` (config file) / `flowLogsFileMaxFiles` (YAML)

Sets the number of log files to keep.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileMaxFiles` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `5` |
| `FelixConfiguration` field | `flowLogsFileMaxFiles` (YAML) `FlowLogsFileMaxFiles` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `5` |

### `FlowLogsFileNatOutgoingPortLimit` (config file) / `flowLogsFileNatOutgoingPortLimit` (YAML)

Used to specify the maximum number of distinct post SNAT ports that will appear
in the flowLogs. Default value is 3.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFileNatOutgoingPortLimit` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `3` |
| `FelixConfiguration` field | `flowLogsFileNatOutgoingPortLimit` (YAML) `FlowLogsFileNatOutgoingPortLimit` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `3` |

### `FlowLogsFilePerFlowProcessArgsLimit` (config file) / `flowLogsFilePerFlowProcessArgsLimit` (YAML)

Used to specify the maximum number of distinct process args that will appear in the flowLogs.
Default value is 5.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFilePerFlowProcessArgsLimit` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `5` |
| `FelixConfiguration` field | `flowLogsFilePerFlowProcessArgsLimit` (YAML) `FlowLogsFilePerFlowProcessArgsLimit` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `5` |

### `FlowLogsFilePerFlowProcessLimit` (config file) / `flowLogsFilePerFlowProcessLimit` (YAML)

Used to specify the maximum number of flow log entries with distinct process information
beyond which process information will be aggregated.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsFilePerFlowProcessLimit` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `2` |
| `FelixConfiguration` field | `flowLogsFilePerFlowProcessLimit` (YAML) `FlowLogsFilePerFlowProcessLimit` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `2` |
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_FlowLogsPositionFilePath` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `/var/log/calico/flows.log.pos` |
| `FelixConfiguration` field | `flowLogsPositionFilePath` (YAML) `FlowLogsPositionFilePath` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `/var/log/calico/flows.log.pos` |

## <a id="dns-logs--policy">DNS logs / policy

### `DNSCacheEpoch` (config file) / `dnsCacheEpoch` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSCacheEpoch` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `0` |
| `FelixConfiguration` field | `dnsCacheEpoch` (YAML) `DNSCacheEpoch` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `0` |

### `DNSCacheFile` (config file) / `dnsCacheFile` (YAML)

The name of the file that Felix uses to preserve learnt DNS information when restarting. .

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSCacheFile` |
| Encoding (env var/config file) | Path to file |
| Default value (above encoding) | `/var/run/calico/felix-dns-cache.txt` |
| `FelixConfiguration` field | `dnsCacheFile` (YAML) `DNSCacheFile` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `/var/run/calico/felix-dns-cache.txt` |

### `DNSCacheSaveInterval` (config file) / `dnsCacheSaveInterval` (YAML)

The periodic interval at which Felix saves learnt DNS information to the cache file. .

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSCacheSaveInterval` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `60` (1m0s) |
| `FelixConfiguration` field | `dnsCacheSaveInterval` (YAML) `DNSCacheSaveInterval` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `1m0s` |

### `DNSExtraTTL` (config file) / `dnsExtraTTL` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSExtraTTL` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `0` (0s) |
| `FelixConfiguration` field | `dnsExtraTTL` (YAML) `DNSExtraTTL` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `0s` |

### `DNSLogsFileAggregationKind` (config file) / `dnsLogsFileAggregationKind` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsFileAggregationKind` |
| Encoding (env var/config file) | Integer: [0,1] |
| Default value (above encoding) | `1` |
| `FelixConfiguration` field | `dnsLogsFileAggregationKind` (YAML) `DNSLogsFileAggregationKind` (Go API) |
| `FelixConfiguration` schema | One of: <code>0</code>, <code>1</code>. |
| Default value (YAML) | `1` |

### `DNSLogsFileDirectory` (config file) / `dnsLogsFileDirectory` (YAML)

Sets the directory where DNS log files are stored.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsFileDirectory` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `/var/log/calico/dnslogs` |
| `FelixConfiguration` field | `dnsLogsFileDirectory` (YAML) `DNSLogsFileDirectory` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `/var/log/calico/dnslogs` |

### `DNSLogsFileEnabled` (config file) / `dnsLogsFileEnabled` (YAML)

Controls logging DNS logs to a file. If false no DNS logging to file will occur.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsFileEnabled` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |
| `FelixConfiguration` field | `dnsLogsFileEnabled` (YAML) `DNSLogsFileEnabled` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `false` |

### `DNSLogsFileIncludeLabels` (config file) / `dnsLogsFileIncludeLabels` (YAML)

Used to configure if endpoint labels are included in a DNS log entry written to file.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsFileIncludeLabels` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `true` |
| `FelixConfiguration` field | `dnsLogsFileIncludeLabels` (YAML) `DNSLogsFileIncludeLabels` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `true` |

### `DNSLogsFileMaxFileSizeMB` (config file) / `dnsLogsFileMaxFileSizeMB` (YAML)

Sets the max size in MB of DNS log files before rotation.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsFileMaxFileSizeMB` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `100` |
| `FelixConfiguration` field | `dnsLogsFileMaxFileSizeMB` (YAML) `DNSLogsFileMaxFileSizeMB` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `100` |

### `DNSLogsFileMaxFiles` (config file) / `dnsLogsFileMaxFiles` (YAML)

Sets the number of DNS log files to keep.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsFileMaxFiles` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `5` |
| `FelixConfiguration` field | `dnsLogsFileMaxFiles` (YAML) `DNSLogsFileMaxFiles` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `5` |

### `DNSLogsFilePerNodeLimit` (config file) / `dnsLogsFilePerNodeLimit` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsFilePerNodeLimit` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `0` |
| `FelixConfiguration` field | `dnsLogsFilePerNodeLimit` (YAML) `DNSLogsFilePerNodeLimit` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `0` |

### `DNSLogsFlushInterval` (config file) / `dnsLogsFlushInterval` (YAML)

Configures the interval at which Felix exports DNS logs.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsFlushInterval` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `300` (5m0s) |
| `FelixConfiguration` field | `dnsLogsFlushInterval` (YAML) `DNSLogsFlushInterval` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `5m0s` |

### `DNSLogsLatency` (config file) / `dnsLogsLatency` (YAML)

Indicates to include measurements of DNS request/response latency in each DNS log.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSLogsLatency` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `true` |
| `FelixConfiguration` field | `dnsLogsLatency` (YAML) `DNSLogsLatency` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `true` |

### `DNSPacketsNfqueueID` (config file) / `dnsPacketsNfqueueID` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSPacketsNfqueueID` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `101` |
| `FelixConfiguration` field | `dnsPacketsNfqueueID` (YAML) `DNSPacketsNfqueueID` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `101` |

### `DNSPacketsNfqueueMaxHoldDuration` (config file) / `dnsPacketsNfqueueMaxHoldDuration` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSPacketsNfqueueMaxHoldDuration` |
| Encoding (env var/config file) | Milliseconds (floating point) |
| Default value (above encoding) | `3000` (3s) |
| `FelixConfiguration` field | `dnsPacketsNfqueueMaxHoldDuration` (YAML) `DNSPacketsNfqueueMaxHoldDuration` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `3s` |

### `DNSPacketsNfqueueSize` (config file) / `dnsPacketsNfqueueSize` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSPacketsNfqueueSize` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `100` |
| `FelixConfiguration` field | `dnsPacketsNfqueueSize` (YAML) `DNSPacketsNfqueueSize` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `100` |

### `DNSPolicyMode` (config file) / `dnsPolicyMode` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSPolicyNfqueueID` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `100` |
| `FelixConfiguration` field | `dnsPolicyNfqueueID` (YAML) `DNSPolicyNfqueueID` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `100` |

### `DNSPolicyNfqueueSize` (config file) / `dnsPolicyNfqueueSize` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSPolicyNfqueueSize` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `255` |
| `FelixConfiguration` field | `dnsPolicyNfqueueSize` (YAML) `DNSPolicyNfqueueSize` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `255` |

### `DNSTrustedServers` (config file) / `dnsTrustedServers` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DNSTrustedServers` |
| Encoding (env var/config file) | Comma-delimited list of DNS servers. Each entry can be: <code>&lt;IP address&gt;</code>, an <code>&lt;IP address&gt;:&lt;port&gt;</code> (IPv6 addresses must be wrapped in square brackets), or, a Kubernetes service name <code>k8s-service:(namespace/)service-name</code>. |
| Default value (above encoding) | `k8s-service:kube-dns` |
| `FelixConfiguration` field | `dnsTrustedServers` (YAML) `DNSTrustedServers` (Go API) |
| `FelixConfiguration` schema | List of strings: <code>["&lt;string&gt;", ...]</code>. |
| Default value (YAML) | none |

## <a id="l-logs">L7 logs

### `L7LogsFileAggregationDestinationInfo` (config file) / `l7LogsFileAggregationDestinationInfo` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationDestinationInfo` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `IncludeL7DestinationInfo` |
| `FelixConfiguration` field | `l7LogsFileAggregationDestinationInfo` (YAML) `L7LogsFileAggregationDestinationInfo` (Go API) |
| `FelixConfiguration` schema | One of: <code>ExcludeL7DestinationInfo</code>, <code>IncludeL7DestinationInfo</code>. |
| Default value (YAML) | `IncludeL7DestinationInfo` |

### `L7LogsFileAggregationHTTPHeaderInfo` (config file) / `l7LogsFileAggregationHTTPHeaderInfo` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationHTTPHeaderInfo` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `ExcludeL7HTTPHeaderInfo` |
| `FelixConfiguration` field | `l7LogsFileAggregationHTTPHeaderInfo` (YAML) `L7LogsFileAggregationHTTPHeaderInfo` (Go API) |
| `FelixConfiguration` schema | One of: <code>ExcludeL7HTTPHeaderInfo</code>, <code>IncludeL7HTTPHeaderInfo</code>. |
| Default value (YAML) | `ExcludeL7HTTPHeaderInfo` |

### `L7LogsFileAggregationHTTPMethod` (config file) / `l7LogsFileAggregationHTTPMethod` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationHTTPMethod` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `IncludeL7HTTPMethod` |
| `FelixConfiguration` field | `l7LogsFileAggregationHTTPMethod` (YAML) `L7LogsFileAggregationHTTPMethod` (Go API) |
| `FelixConfiguration` schema | One of: <code>ExcludeL7HTTPMethod</code>, <code>IncludeL7HTTPMethod</code>. |
| Default value (YAML) | `IncludeL7HTTPMethod` |

### `L7LogsFileAggregationNumURLPath` (config file) / `l7LogsFileAggregationNumURLPath` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationNumURLPath` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `5` |
| `FelixConfiguration` field | `l7LogsFileAggregationNumURLPath` (YAML) `L7LogsFileAggregationNumURLPath` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `5` |

### `L7LogsFileAggregationResponseCode` (config file) / `l7LogsFileAggregationResponseCode` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationResponseCode` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `IncludeL7ResponseCode` |
| `FelixConfiguration` field | `l7LogsFileAggregationResponseCode` (YAML) `L7LogsFileAggregationResponseCode` (Go API) |
| `FelixConfiguration` schema | One of: <code>ExcludeL7ResponseCode</code>, <code>IncludeL7ResponseCode</code>. |
| Default value (YAML) | `IncludeL7ResponseCode` |

### `L7LogsFileAggregationServiceInfo` (config file) / `l7LogsFileAggregationServiceInfo` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationServiceInfo` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `IncludeL7ServiceInfo` |
| `FelixConfiguration` field | `l7LogsFileAggregationServiceInfo` (YAML) `L7LogsFileAggregationServiceInfo` (Go API) |
| `FelixConfiguration` schema | One of: <code>ExcludeL7ServiceInfo</code>, <code>IncludeL7ServiceInfo</code>. |
| Default value (YAML) | `IncludeL7ServiceInfo` |

### `L7LogsFileAggregationSourceInfo` (config file) / `l7LogsFileAggregationSourceInfo` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationSourceInfo` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `IncludeL7SourceInfoNoPort` |
| `FelixConfiguration` field | `l7LogsFileAggregationSourceInfo` (YAML) `L7LogsFileAggregationSourceInfo` (Go API) |
| `FelixConfiguration` schema | One of: <code>ExcludeL7SourceInfo</code>, <code>IncludeL7SourceInfo</code>, <code>IncludeL7SourceInfoNoPort</code>. |
| Default value (YAML) | `IncludeL7SourceInfoNoPort` |

### `L7LogsFileAggregationTrimURL` (config file) / `l7LogsFileAggregationTrimURL` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationTrimURL` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `IncludeL7FullURL` |
| `FelixConfiguration` field | `l7LogsFileAggregationTrimURL` (YAML) `L7LogsFileAggregationTrimURL` (Go API) |
| `FelixConfiguration` schema | One of: <code>ExcludeL7URL</code>, <code>IncludeL7FullURL</code>, <code>TrimURLQuery</code>, <code>TrimURLQueryAndPath</code>. |
| Default value (YAML) | `IncludeL7FullURL` |

### `L7LogsFileAggregationURLCharLimit` (config file) / `l7LogsFileAggregationURLCharLimit` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileAggregationURLCharLimit` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `250` |
| `FelixConfiguration` field | `l7LogsFileAggregationURLCharLimit` (YAML) `L7LogsFileAggregationURLCharLimit` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `250` |

### `L7LogsFileDirectory` (config file) / `l7LogsFileDirectory` (YAML)

Sets the directory where L7 log files are stored.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileDirectory` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `/var/log/calico/l7logs` |
| `FelixConfiguration` field | `l7LogsFileDirectory` (YAML) `L7LogsFileDirectory` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `/var/log/calico/l7logs` |

### `L7LogsFileEnabled` (config file) / `l7LogsFileEnabled` (YAML)

Controls logging L7 logs to a file. If false no L7 logging to file will occur.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileEnabled` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `true` |
| `FelixConfiguration` field | `l7LogsFileEnabled` (YAML) `L7LogsFileEnabled` (Go API) |
| `FelixConfiguration` schema | Boolean. |
| Default value (YAML) | `true` |

### `L7LogsFileMaxFileSizeMB` (config file) / `l7LogsFileMaxFileSizeMB` (YAML)

Sets the max size in MB of L7 log files before rotation.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileMaxFileSizeMB` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `100` |
| `FelixConfiguration` field | `l7LogsFileMaxFileSizeMB` (YAML) `L7LogsFileMaxFileSizeMB` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `100` |

### `L7LogsFileMaxFiles` (config file) / `l7LogsFileMaxFiles` (YAML)

Sets the number of L7 log files to keep.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFileMaxFiles` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `5` |
| `FelixConfiguration` field | `l7LogsFileMaxFiles` (YAML) `L7LogsFileMaxFiles` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `5` |

### `L7LogsFilePerNodeLimit` (config file) / `l7LogsFilePerNodeLimit` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFilePerNodeLimit` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `1500` |
| `FelixConfiguration` field | `l7LogsFilePerNodeLimit` (YAML) `L7LogsFilePerNodeLimit` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `1500` |

### `L7LogsFlushInterval` (config file) / `l7LogsFlushInterval` (YAML)

Configures the interval at which Felix exports L7 logs.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_L7LogsFlushInterval` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `300` (5m0s) |
| `FelixConfiguration` field | `l7LogsFlushInterval` (YAML) `L7LogsFlushInterval` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `5m0s` |

## <a id="aws-integration">AWS integration

### `AWSRequestTimeout` (config file) / `awsRequestTimeout` (YAML)

The timeout on AWS API requests.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_AWSRequestTimeout` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `30` (30s) |
| `FelixConfiguration` field | `awsRequestTimeout` (YAML) `AWSRequestTimeout` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `30s` |

### `AWSSecondaryIPRoutingRulePriority` (config file) / `awsSecondaryIPRoutingRulePriority` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_AWSSecondaryIPRoutingRulePriority` |
| Encoding (env var/config file) | Integer: [0,4294967295] |
| Default value (above encoding) | `101` |
| `FelixConfiguration` field | `awsSecondaryIPRoutingRulePriority` (YAML) `AWSSecondaryIPRoutingRulePriority` (Go API) |
| `FelixConfiguration` schema | Integer: [0,4294967295] |
| Default value (YAML) | `101` |

### `AWSSecondaryIPSupport` (config file) / `awsSecondaryIPSupport` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_AWSSecondaryIPSupport` |
| Encoding (env var/config file) | One of: <code>Disabled</code>, <code>EnabledENIPerWorkload</code>, <code>Enabled</code> (case insensitive) |
| Default value (above encoding) | `Disabled` |
| `FelixConfiguration` field | `awsSecondaryIPSupport` (YAML) `AWSSecondaryIPSupport` (Go API) |
| `FelixConfiguration` schema | One of: <code>Disabled</code>, <code>Enabled</code>, <code>EnabledENIPerWorkload</code>. |
| Default value (YAML) | `Disabled` |
...
## <a id="egress-gateway">Egress gateway

### `EgressGatewayPollFailureCount` (config file) / `egressGatewayPollFailureCount` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_EgressGatewayPollFailureCount` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `3` |
| `FelixConfiguration` field | `egressGatewayPollFailureCount` (YAML) `EgressGatewayPollFailureCount` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `3` |

### `EgressGatewayPollInterval` (config file) / `egressGatewayPollInterval` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_EgressGatewayPollInterval` |
| Encoding (env var/config file) | Seconds (floating point) |
| Default value (above encoding) | `10` (10s) |
| `FelixConfiguration` field | `egressGatewayPollInterval` (YAML) `EgressGatewayPollInterval` (Go API) |
| `FelixConfiguration` schema | Duration string, for example <code>1m30s123ms</code> or <code>1h5m</code>. |
| Default value (YAML) | `10s` |
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_EgressIPRoutingRulePriority` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `100` |
| `FelixConfiguration` field | `egressIPRoutingRulePriority` (YAML) `EgressIPRoutingRulePriority` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `100` |

### `EgressIPSupport` (config file) / `egressIPSupport` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_EgressIPSupport` |
| Encoding (env var/config file) | One of: <code>Disabled</code>, <code>EnabledPerNamespaceOrPerPod</code>, <code>EnabledPerNamespace</code> (case insensitive) |
| Default value (above encoding) | `Disabled` |
| `FelixConfiguration` field | `egressIPSupport` (YAML) `EgressIPSupport` (Go API) |
| `FelixConfiguration` schema | One of: <code>Disabled</code>, <code>EnabledPerNamespace</code>, <code>EnabledPerNamespaceOrPerPod</code>. |
| Default value (YAML) | `Disabled` |

### `EgressIPVXLANPort` (config file) / `egressIPVXLANPort` (YAML)

The port number of vxlan tunnel device for egress traffic.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_EgressIPVXLANPort` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `4790` |
| `FelixConfiguration` field | `egressIPVXLANPort` (YAML) `EgressIPVXLANPort` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `4790` |

### `EgressIPVXLANVNI` (config file) / `egressIPVXLANVNI` (YAML)

The VNI ID of vxlan tunnel device for egress traffic.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_EgressIPVXLANVNI` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `4097` |
| `FelixConfiguration` field | `egressIPVXLANVNI` (YAML) `EgressIPVXLANVNI` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `4097` |

## <a id="external-network-support">External network support

### `ExternalNetworkRoutingRulePriority` (config file) / `externalNetworkRoutingRulePriority` (YAML)

Controls the priority value to use for the external network routing rule.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_ExternalNetworkRoutingRulePriority` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `102` |
| `FelixConfiguration` field | `externalNetworkRoutingRulePriority` (YAML) `ExternalNetworkRoutingRulePriority` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `102` |

### `ExternalNetworkSupport` (config file) / `externalNetworkSupport` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_ExternalNetworkSupport` |
| Encoding (env var/config file) | One of: <code>Disabled</code>, <code>Enabled</code> (case insensitive) |
| Default value (above encoding) | `Disabled` |
| `FelixConfiguration` field | `externalNetworkSupport` (YAML) `ExternalNetworkSupport` (Go API) |
| `FelixConfiguration` schema | One of: <code>Disabled</code>, <code>Enabled</code>. |
| Default value (YAML) | `Disabled` |

## <a id="packet-capture">Packet capture

### `CaptureDir` (config file) / `captureDir` (YAML)

Controls directory to store file capture.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_CaptureDir` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | `/var/log/calico/pcap` |
| `FelixConfiguration` field | `captureDir` (YAML) `CaptureDir` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `/var/log/calico/pcap` |

### `CaptureMaxFiles` (config file) / `captureMaxFiles` (YAML)

Controls number of rotated capture file to keep.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_CaptureMaxFiles` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `2` |
| `FelixConfiguration` field | `captureMaxFiles` (YAML) `CaptureMaxFiles` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `2` |

### `CaptureMaxSizeBytes` (config file) / `captureMaxSizeBytes` (YAML)

Controls the max size of a file capture.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_CaptureMaxSizeBytes` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `10000000` |
| `FelixConfiguration` field | `captureMaxSizeBytes` (YAML) `CaptureMaxSizeBytes` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `10000000` |

### `CaptureRotationSeconds` (config file) / `captureRotationSeconds` (YAML)

Controls the time rotation of a packet capture.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_CaptureRotationSeconds` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `3600` |
| `FelixConfiguration` field | `captureRotationSeconds` (YAML) `CaptureRotationSeconds` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `3600` |

## <a id="l-proxy">L7 proxy

### `TPROXYMode` (config file) / `tproxyMode` (YAML)

Sets whether traffic is directed through a transparent proxy
for further processing or not and how is the proxying done.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_TPROXYMode` |
| Encoding (env var/config file) | One of: <code>Disabled</code>, <code>EnabledAllServices</code>, <code>Enabled</code> (case insensitive) |
| Default value (above encoding) | `Disabled` |
| `FelixConfiguration` field | `tproxyMode` (YAML) `TPROXYMode` (Go API) |
| `FelixConfiguration` schema | One of: <code>Disabled</code>, <code>Enabled</code>, <code>EnabledAllServices</code>. |
| Default value (YAML) | `Disabled` |

### `TPROXYPort` (config file) / `tproxyPort` (YAML)

Sets to which port proxied traffic should be redirected.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_TPROXYPort` |
| Encoding (env var/config file) | Integer |
| Default value (above encoding) | `16001` |
| `FelixConfiguration` field | `tproxyPort` (YAML) `TPROXYPort` (Go API) |
| `FelixConfiguration` schema | Integer |
| Default value (YAML) | `16001` |

### `TPROXYUpstreamConnMark` (config file) / `tproxyUpstreamConnMark` (YAML)
...
| Detail |   |
| --- | --- |
| Environment variable | `FELIX_TPROXYUpstreamConnMark` |
| Encoding (env var/config file) | 32-bit bitmask (hex or deccimal allowed) with at least 2 bits set, example: <code>0xffff0000</code> |
| Default value (above encoding) | `0x17` |
| `FelixConfiguration` field | `tproxyUpstreamConnMark` (YAML) `TPROXYUpstreamConnMark` (Go API) |
| `FelixConfiguration` schema | Unsigned 32-bit integer. |
| Default value (YAML) | `0x17` |
...
### `DebugCloudWatchLogsFile` (config file / env var only)

Unsupported diagnostic setting, used when testing Felix.  Not exposed in `FelixConfiguration`.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DebugCloudWatchLogsFile` |
| Encoding (env var/config file) | Path to file |
| Default value (above encoding) | none |

### `DebugConsoleEnabled` (config file / env var only)

Unsupported diagnostic setting, used when testing Felix.  Not exposed in `FelixConfiguration`.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DebugConsoleEnabled` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |

### `DebugDNSDoNotWriteIPSets` (config file / env var only)

Unsupported diagnostic setting, used when testing Felix.  Not exposed in `FelixConfiguration`.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DebugDNSDoNotWriteIPSets` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |

### `DebugDNSResponseDelay` (config file / env var only)

Unsupported diagnostic setting, used when testing Felix.  Not exposed in `FelixConfiguration`.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DebugDNSResponseDelay` |
| Encoding (env var/config file) | Milliseconds (floating point) |
| Default value (above encoding) | `0` (0s) |
...
### `DebugUseShortPollIntervals` (config file / env var only)

Unsupported diagnostic setting, used when testing Felix.  Not exposed in `FelixConfiguration`.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DebugUseShortPollIntervals` |
| Encoding (env var/config file) | Boolean: <code>true</code>, <code>1</code>, <code>yes</code>, <code>y</code>, <code>t</code> accepted as True; <code>false</code>, <code>0</code>, <code>no</code>, <code>n</code>, <code>f</code> accepted (case insensitively) as False. |
| Default value (above encoding) | `false` |

### `DebugWindowsPktMonStartArgs` (config file / env var only)

Unsupported diagnostic setting, used when testing Felix.  Not exposed in `FelixConfiguration`.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_DebugWindowsPktMonStartArgs` |
| Encoding (env var/config file) | String |
| Default value (above encoding) | none |

### `StatsDumpFilePath` (config file) / `statsDumpFilePath` (YAML)

The path to write a diagnostic flow logs statistics dump to when triggered by signal.

| Detail |   |
| --- | --- |
| Environment variable | `FELIX_StatsDumpFilePath` |
| Encoding (env var/config file) | Path to file |
| Default value (above encoding) | `/var/log/calico/stats/dump` |
| `FelixConfiguration` field | `statsDumpFilePath` (YAML) `StatsDumpFilePath` (Go API) |
| `FelixConfiguration` schema | String. |
| Default value (YAML) | `/var/log/calico/stats/dump` |
| Notes | Felix will exit if the value is invalid. | 
