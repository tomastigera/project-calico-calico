...
func EmptyObject() runtime.Object {
	return &calico.GlobalAlertTemplate{}
}

// NewList returns a new shell of a binding list
func NewList() runtime.Object {
	return &calico.GlobalAlertTemplateList{}
}
...
func NewREST(scheme *runtime.Scheme, opts server.Options) (*REST, error) {
	...
	store := &registry.Store{
		...
		ObjectNameFunc: func(obj runtime.Object) (string, error) {
			return obj.(*calico.GlobalAlertTemplate).Name, nil
		},
		PredicateFunc:            MatchAlert,
		DefaultQualifiedResource: calico.Resource("globalalerttemplates"),
