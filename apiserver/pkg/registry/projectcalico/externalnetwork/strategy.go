...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	apiserver, ok := obj.(*calico.ExternalNetwork)
	if !ok {
...
func MatchExternalNetwork(label labels.Selector, field fields.Selector) storage.SelectionPredicate {
...
// ExternalNetworkToSelectableFields returns a field set that represents the object.
func ExternalNetworkToSelectableFields(obj *calico.ExternalNetwork) fields.Set {
