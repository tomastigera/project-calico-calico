...
func MatchRemoteClusterConfiguration(label labels.Selector, field fields.Selector) storage.SelectionPredicate {
...
// RemoteClusterConfigurationToSelectableFields returns a field set that represents the object.
func RemoteClusterConfigurationToSelectableFields(obj *calico.RemoteClusterConfiguration) fields.Set {
