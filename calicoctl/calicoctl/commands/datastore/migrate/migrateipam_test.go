...
func (c *MockIPAMClient) RemoteClusterConfigurations() client.RemoteClusterConfigurationInterface {
	return nil
}

func (c *MockIPAMClient) LicenseKey() client.LicenseKeyInterface {
	return nil
}

func (c *MockIPAMClient) GlobalAlerts() client.GlobalAlertInterface {
	return nil
}

func (c *MockIPAMClient) GlobalAlertTemplates() client.GlobalAlertTemplateInterface {
	return nil
}

func (c *MockIPAMClient) GlobalThreatFeeds() client.GlobalThreatFeedInterface {
	return nil
}

func (c *MockIPAMClient) GlobalReportTypes() client.GlobalReportTypeInterface {
	return nil
}

func (c *MockIPAMClient) GlobalReports() client.GlobalReportInterface {
	return nil
}

func (c *MockIPAMClient) DeepPacketInspections() client.DeepPacketInspectionInterface {
	return nil
}

func (c *MockIPAMClient) ManagedClusters() client.ManagedClusterInterface {
	return nil
}

func (c *MockIPAMClient) PacketCaptures() client.PacketCaptureInterface {
	return nil
}
...
func (c *MockIPAMClient) PolicyRecommendationScopes() client.PolicyRecommendationScopeInterface {
	// DO NOTHING
	return nil
}
