...
class TestCalicoctlCommands(TestBase):
    ...
    def test_non_namespaced_uisettingsgroup(self):
        self._test_non_namespaced(uisettingsgroup_name1_rev1)
    ...
    def test_namespaced_packetcapture(self):
        self._test_namespaced(packetcapture_name1_rev1)
    ...
    def test_tier_list_order(self):
        ...
        # TODO(mazdak): This is the correct order with ClusterNetworkPolicy Enabled. Change when it's fully supported.
        ...
        self.assertEqual(tierList['items'][4]['metadata']['name'], 'baselineadminnetworkpolicy')
    ...
    def test_basic_crud_packetcapture(self):
        self._test_basic_crud(packetcapture_name1_rev1, packetcapture_name2_rev1)

    def _test_basic_crud(self, any_resource, another_resource):
        """
    ...
    def test_update_packetcapture_replace(self):
        self._test_update(packetcapture_name1_rev1, 'replace', packetcapture_name1_rev2)

    def test_update_packetcapture_apply(self):
        self._test_update(packetcapture_name1_rev1, 'apply', packetcapture_name1_rev2)

    def test_update_packetcapture_patch(self):
        self._test_update(packetcapture_name1_rev1, 'patch %s %s --namespace %s -p %s' % (kind(packetcapture_name1_rev1), name(packetcapture_name1_rev1), namespace(packetcapture_name1_rev1), "'{\"spec\":{\"selector\": \"\"}}'"),None)

    def _test_update(self, resource, update_cmd, revision):
        """
