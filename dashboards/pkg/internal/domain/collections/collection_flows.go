...
var collectionFlows = Collection{
	...
	fields: []CollectionField{
		...
		collectionFieldGeneric{fieldType: FieldTypeLabels, fieldName: "dest_labels.labels", displayFieldType: FieldTypeText},
		...
		collectionFieldGeneric{fieldType: FieldTypeLabels, fieldName: "source_labels.labels", displayFieldType: FieldTypeText},
