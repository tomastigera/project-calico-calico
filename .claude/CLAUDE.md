...
This is the private, Enterprise fork of Project Calico.
...
```
Enterprise fork: new/heavily modified files should be "All rights reserved", not Apache.
Files from third party projects (i.e. non-Tigera copyright in the file) should 
be managed carefully.  Maintain the copyright and license header of the third
party. Add our copyright header for changes.
