...
func IsAllowed(w http.ResponseWriter, r *http.Request) (allow bool, err error) {
	...
	case r.URL.Path == "/_bulk" && r.Method == http.MethodPost:
		...
		// {"update":{"_id":"task:endpoint:user-artifact-packager:1.0.0","_index":".kibana_task_manager_8.17.4"}}
	...
	case strings.HasPrefix(r.URL.Path, "/.kibana"):
		...
		// DELETE /.kibana_task_manager_8.17.4/_doc/
		// GET /.kibana_8.17.4/_doc/
		// GET /.kibana%2C.kibana_8.17.4?ignore_unavailable=true
		// GET /.kibana_task_manager%2C.kibana_task_manager_8.17.4?ignore_unavailable=true
		// GET /.kibana-event-log-*/_alias
		// GET /.kibana-event-log-*/_settings
		// GET /.kibana_security_session_1/_doc
		// GET /.kibana_task_manager_8.17.4/_doc/
		// POST /.kibana_8.17.4_001/_pit?keep_alive=10m
		// POST /.kibana_8.17.4_001/_update_by_query
		// POST /.kibana_8.17.4/_search
		// POST /.kibana_8.17.4/_update
		// POST /.kibana_task_manager_8.17.4_001/_pit?keep_alive=10m
		// POST /.kibana_task_manager_8.17.4_001/_update_by_query
		// POST /.kibana_task_manager/_search
		// POST /.kibana_task_manager/_update_by_query
		// PUT /.kibana_8.17.4_001/_mapping?timeout=60s
		// PUT /.kibana_8.17.4/_create
		// PUT /.kibana_8.17.4/_doc
		// PUT /.kibana_task_manager_8.17.4_001/_mapping?
		// PUT /.kibana_task_manager_8.17.4/_create
	...
	case r.URL.Path == "/_security/user/_has_privileges" && r.Method == http.MethodPost:
		...
		// {"index":[],"application":[{"application":"kibana-.kibana","resources":["*"],"privileges":["version:8.17.4","login:","ui:8.17.4:enterpriseSearch/all"]}]
	...
	case strings.HasPrefix(r.URL.Path, "/_cluster/health/.kibana") && r.Method == http.MethodGet && hasQueryParam(r, "wait_for_status", "yellow"):
		...
		// GET /_cluster/health/.kibana_task_manager_8.17.4_001?wait_for_status=yellow&timeout=60s
	...
	case r.URL.Path == "/_mget" && r.Method == http.MethodPost:
		// This is a request Kibana makes when loading Discovery and Dashboards
		// POST /_mget
		// {"docs":[{"_id":"dashboard:3a849d80-e970-11ea-83c8-edded0d3c4d6","_index":".kibana_8.17.4"}]}
	...
	case strings.HasPrefix(r.URL.Path, "/_alias/.kibana-event-log") && r.Method == http.MethodHead:
		...
		// HEAD /_alias/.kibana-event-log-8.17.4
	...
	case strings.HasPrefix(r.URL.Path, "/_index_template/.kibana-event-log") && r.Method == http.MethodHead:
		// This request is needed by the event log plugin
		// HEAD /_index_template/.kibana-event-log-8.17.4-template
		// Elastic API: https://www.elastic.co/guide/en/elasticsearch/reference/7.17/indices-template-exists-v1.html
		return true, nil
	case strings.HasPrefix(r.URL.Path, "/_template/.kibana-event-log") && r.Method == http.MethodHead:
		// This request is needed by the event log plugin
		// HEAD /_template/.kibana-event-log-8.17.4-template
		// Elastic API: https://www.elastic.co/guide/en/elasticsearch/reference/7.17/indices-template-exists-v1.html
		return true, nil
...
//	   {
//	     "add": {
//	       "index": ".kibana_task_manager_8.17.4_001",
...
//	     "add": {
//	       "index": ".kibana_task_manager_8.17.4_001",
//	       "alias": ".kibana_task_manager_8.17.4"
//	     }
//	   }
//	 ]
//	}
