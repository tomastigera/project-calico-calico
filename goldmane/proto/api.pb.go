...
const file_api_proto_rawDesc = "" +
	"\n" +
	"\tapi.proto\x12\bgoldmane\"\xa5\x02\n" +
	"\x0fFlowListRequest\x12$\n" +
	"\x0estart_time_gte\x18\x01 \x01(\x03R\fstartTimeGte\x12\"\n" +
	"\rstart_time_lt\x18\x02 \x01(\x03R\vstartTimeLt\x12\x1f\n" +
	...
	"\x14aggregation_interval\x18\a \x01(\x03R\x13aggregationInterval\"\x96\x01\n" +
	"\x11FlowStreamRequest\x12$\n" +
	"\x0estart_time_gte\x18\x01 \x01(\x03R\fstartTimeGte\x12(\n" +
	"\x06filter\x18\x02 \x01(\v2\x10.goldmane.FilterR\x06filter\x121\n" +
	"\x14aggregation_interval\x18\x03 \x01(\x03R\x13aggregationInterval\"\xb2\x01\n" +
	...
	"\rstart_time_lt\x18\x04 \x01(\x03R\vstartTimeLt\"\"\n" +
	"\n" +
	"FilterHint\x12\x14\n" +
	...
	"\x01x\x18\v \x03(\x03R\x01x*\xaf\x01\n" +
	"\n" +
	"FilterType\x12\x19\n" +
	...
	"\x14FilterTypePolicyTier\x10\x05*>\n" +
	"\x06Action\x12\x15\n" +
	...
	"\n" +
	"\x06Egress\x10\x022\xc6\x01\n" +
	"\x05Flows\x129\n" +
	"\x04List\x12\x19.goldmane.FlowListRequest\x1a\x14.goldmane.FlowResult0\x01\x12=\n" +
	"\x06Stream\x12\x1b.goldmane.FlowStreamRequest\x1a\x14.goldmane.FlowResult0\x01\x12C\n" +
	"\vFilterHints\x12\x1c.goldmane.FilterHintsRequest\x1a\x14.goldmane.FilterHint0\x012K\n" +
	"\rFlowCollector\x12:\n" +
