...
var collectionDNS = Collection{
	...
	fields: []CollectionField{
		...
		collectionFieldGeneric{fieldType: FieldTypeNumber, fieldName: "latency_max", filterDisabled: true},
		collectionFieldGeneric{fieldType: FieldTypeNumber, fieldName: "latency_mean", filterDisabled: true},
