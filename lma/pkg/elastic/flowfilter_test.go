...
var _ = Describe("FlowFilter", func() {
	DescribeTable(
		...
		Entry("Should return true if the user can list pods in the source namespace but not the destination",
		...
		Entry("Should return true if the user can list pods in the destination namespace but not the source",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "wep"},
					{"source_namespace", "ns1"},
		...
		Entry("Should return true if the user can list pods in the destination namespace and the source is of type 'net'",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "net"},
					{"source_namespace", ""},
		...
		Entry("Should return true if the user can list pods in the source namespace and the destination is of type 'net'",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "wep"},
					{"source_namespace", "ns1"},
		...
		Entry("Should return false if the user can't list host endpoints and the flow's source type is a host "+"endpoint and the destination type is net",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "hep"},
					{"source_namespace", ""},
		...
		Entry("Should return true if the user can't list host endpoints, the flow's destination type is a host "+"endpoint and the source type is net",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "net"},
					{"source_namespace", ""},
		...
		Entry("Should return true if the user can list global network sets, the source type is ns without a namespace "+"and the destination type is net",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "net"},
					{"source_namespace", ""},
		...
		Entry("Should return false if the user can't list global network sets, the source type is ns without a namespace "+"and the destination type is net",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "net"},
					{"source_namespace", ""},
		...
		Entry("Should return true if the user can list the network set in the sources namespace, the source type "+"is ns, and the destination type is net",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "net"},
					{"source_namespace", "ns1"},
		...
		Entry("Should return false if the user can't list the network set in the sources namespace, the source type "+"is ns, and the destination type is net",
			&elastic.CompositeAggregationBucket{
				CompositeAggregationKey: elastic.CompositeAggregationKey{
					{"source_type", "net"},
					{"source_namespace", "ns1"},
	...
	DescribeTable(
		...
		Entry("Should not modify the flow if the user has access to all policy types",
			&elastic.CompositeAggregationBucket{
		...
		Entry("Should not modify all non staged flows if the user only has access to staged flows",
			&elastic.CompositeAggregationBucket{
				AggregatedTerms: map[string]*elastic.AggregatedTerm{
					"policies": {
						Buckets: map[any]int64{
		...
		Entry("Should not modify all non staged flows if the user only has access to staged flows, mixed policies",
			&elastic.CompositeAggregationBucket{
				AggregatedTerms: map[string]*elastic.AggregatedTerm{
					"policies": {
						Buckets: map[any]int64{
		...
		Entry("Should not modify all staged flows if the user only has access to non staged flows",
			&elastic.CompositeAggregationBucket{
				AggregatedTerms: map[string]*elastic.AggregatedTerm{
					"policies": {
						Buckets: map[any]int64{
