...
func Run(bird, bird6, felixReady, felixLive, birdLive, bird6Live, bgpMetricsReady bool, thresholdTime time.Duration) {
	if err := RunOutput(bird, bird6, felixReady, felixLive, birdLive, bird6Live, bgpMetricsReady, thresholdTime); err != nil {
		fmt.Printf("%s\n", err)
		os.Exit(1)
	}
	os.Exit(0)
...
func RunOutput(bird, bird6, felixReady, felixLive, birdLive, bird6Live, bgpMetricsReady bool, thresholdTime time.Duration) error {
